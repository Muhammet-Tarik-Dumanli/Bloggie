namespace Bloggie.Data
{
    public static class ApplicationDbContextSeed
    {
        ...
        {
            await db.Database.MigrateAsync(); //Veri tabanı yoksa oluşturur, migration yapılmadıysa yapar

            var adminEmail = "admin@example.com";
            var adminPass = "P@ssword1";
            var adminRole = "Administrator";

            var cat1 = new Category() { Name = "Sample Category 1", Slug = "sample-category-1" };
